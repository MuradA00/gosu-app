...
export const ProductList = ({
  ...
  return (
    <div className="flex flex-col gap-5">
      <ul className="grid grid-cols-2 md:!grid-cols-3 xl:!grid-cols-5 gap-2.5 xl:gap-4 grid-rows-1">
        {list.map((product, i) => (
          product.isTelegram ? (
            <li className="bg-red rounded-[14px] p-2.5 sm:p-[14px] flex flex-col justify-between font-medium">
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl uppercase">Telegram GOSU</span>
              ...
              <div className="flex items-center flex-col gap-2.5">
                ...
                <Button className="!bg-[#fff] w-full !text-sm sm:text-base !px-2 !text-black" href="#">
                  Наш телеграм канал
                </Button>
              </div>
            </li>
